function initBunnyLightboxPlayer(container) {
  container = container || document;
  var player = container.querySelector('[data-bunny-lightbox-init]');
  if (!player) return;
...
function bunnyLightbox() {
  document.addEventListener('barba:afterEnter', (e) => {
    initBunnyLightboxPlayer(e.detail.container);
  });
}
export default bunnyLightbox;